...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-[#7E1E1E]/10">
          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
              ...
              <div className="flex items-center gap-3 cursor-pointer" onClick={() => navigate("/")}>
                ...
                <div className="flex flex-col">
                  <div className="flex items-baseline gap-1.5">
                    <h1 className="text-lg sm:text-2xl font-display font-bold text-[#7E1E1E] italic leading-none">
                      OnCanvas
                    </h1>
                    <span className="text-[#7E1E1E]/40 font-body text-[10px] hidden lg:inline">by</span>
                    <span className="text-[10px] sm:text-sm font-body font-semibold text-[#7E1E1E]/70 tracking-wide hidden lg:inline">Aryans Art</span>
                  </div>
                  <p className="hidden md:block text-[10px] tracking-[0.2em] text-[#7E1E1E]/50 font-body uppercase">
            ...
            <div className="hidden md:flex flex-1 max-w-md mx-8">
              <div className="relative w-full">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#7E1E1E]/40" />
                <input
                  type="text"
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-[#7E1E1E]/20 rounded-lg bg-transparent text-sm font-body placeholder:text-[#7E1E1E]/30 focus:outline-none focus:ring-1 focus:ring-[#7E1E1E]/30"
                />
                {searchOpen && searchQuery.trim() !== "" && (
                  <div className="absolute top-full left-0 w-full mt-1 bg-white border border-[#7E1E1E]/10 rounded-lg shadow-xl p-2 z-50 overflow-hidden">
                      ...
                      <div className="flex flex-col">
                        {searchResults.map((product) => (
                          <div
                            ...
                            className="flex items-center gap-3 p-2 hover:bg-[#7E1E1E]/5 rounded-md cursor-pointer transition-colors"
                          >
                            ...
                            <p className="text-xs font-semibold text-[#7E1E1E]">₹{product.price}</p>
                          </div>
                        ))}
                      </div>
                    ) : (
                      <div className="p-4 text-center">
                        <p className="text-sm text-[#7E1E1E]/50 italic">No products found for "{searchQuery}"</p>
                      </div>
                    )}
                  </div>
                )}
            ...
            <div className="flex items-center gap-2 sm:gap-5 font-body text-sm">
              ...
              {isAuthenticated ? (
                <DropdownMenu>
                  <DropdownMenuTrigger className="flex items-center gap-2 text-[#7E1E1E] hover:opacity-80 transition-all focus:outline-none">
                    <Avatar className="w-8 h-8 border border-[#7E1E1E]/20">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-[#7E1E1E] text-white p-2 sm:px-4 sm:py-2 rounded-lg hover:bg-[#7E1E1E]/90 transition-all shadow-sm font-medium"
                >
              ...
              >
                ...
                {count > 0 && (
                  <span className="absolute top-0 right-0 bg-[#7E1E1E] text-white text-[8px] font-bold w-3.5 h-3.5 rounded-full flex items-center justify-center">
                    {count}
                  </span>
                )}
              </button>
              ...
              <button
                ...
                className="md:hidden text-[#7E1E1E] p-1"
              >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-[#7E1E1E]/10 px-4 py-4 space-y-3 shadow-lg">
            {/* Mobile Search */}
            <div className="relative w-full">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[#7E1E1E]/40" />
              <input
              ...
              />
              {searchOpen && searchQuery.trim() !== "" && (
                <div className="absolute top-full left-0 w-full mt-1 bg-white border border-[#7E1E1E]/10 rounded-lg shadow-xl p-2 z-50 max-h-[60vh] overflow-y-auto">
                  {searchResults.length > 0 ? (
                    <div className="flex flex-col">
                      {searchResults.map((product) => (
                        <div
                          ...
                          className="flex items-center gap-3 p-3 hover:bg-[#7E1E1E]/5 rounded-md cursor-pointer transition-colors"
                        >
                    ...
                    <div className="p-4 text-center">
                      <p className="text-sm text-[#7E1E1E]/50 italic">No results found</p>
                    </div>
                  )}
                </div>
              )}
